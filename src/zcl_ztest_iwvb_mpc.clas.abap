class ZCL_ZTEST_IWVB_MPC definition
  public
...
public section.
  ...
  types:
   TS_ZTEST_IWVB_CDSTYPE type ZTEST_IWVB .
  types:
   TT_ZTEST_IWVB_CDSTYPE type standard table of TS_ZTEST_IWVB_CDSTYPE .

  constants GC_ZTEST_IWVB_CDSTYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZTEST_IWVB_CDSType' ##NO_TEXT.
...
CLASS ZCL_ZTEST_IWVB_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZTEST_IWVB_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20191106161651'.                  "#EC NOTEXT
...
*   4
*&---------------------------------------------------------------------*
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20191106161651'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20191106161651'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZTEST_IWVB' )
